...
describe("service detail metadata", () => {
  it("prefers CMS SEO fields when they exist", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "strategy-sprints" }),
      }),
  ...
  it("does not fabricate indexable metadata for unknown slugs", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "missing-service" }),
      }),
    ).resolves.toEqual({
...
describe("work detail metadata", () => {
  it("prefers CMS SEO fields and canonicalizes the route", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "featured-1" }),
      }),
    ).resolves.toMatchObject({
      alternates: {
  ...
  it("returns minimal non-indexable metadata for unknown work slugs", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "missing-work" }),
      }),
    ).resolves.toEqual({
      description: "This page could not be found.",
      robots: {
...
describe("insight detail metadata", () => {
  it("prefers CMS SEO fields when they exist", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "editorial-systems" }),
      }),
    ).resolves.toMatchObject({
      alternates: {
  ...
  it("returns minimal non-indexable metadata for unknown insight slugs", async () => {
    ...
    await expect(
      pageModule.generateMetadata({
        params: Promise.resolve({ locale: "en", slug: "missing-insight" }),
      }),
    ).resolves.toEqual({
      description: "This page could not be found.",
      robots: {
